 ...
 *
 * HERKUNFT: Zeichen fuer Zeichen dieselbe Datei wie
 * `scripts/mini-dom.mjs` im Original (verwaltung-djsamsparkling). Sie liegt
 * dort unter `scripts/`, und `scripts/quellen-holen.mjs` zieht nur `public/`
 * hierher — deshalb steht sie hier als Kopie. Aendert sie sich im Original,
 * gehoert sie auch hier nachgezogen.
 *
